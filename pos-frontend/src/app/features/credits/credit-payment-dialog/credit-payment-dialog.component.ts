...
@Component({
  ...
  template: `
    <div class="pay-wrap">
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <input matInput type="number" [(ngModel)]="amount" (ngModelChange)="calcChange()" />
      </mat-form-field>
      ...
      @if (amount > 0) {
        <div class="change-box" [class.warn]="amount < data.sale.total">
          @if (amount < data.sale.total) {
      ...
      <div mat-dialog-actions class="actions">
        ...
        <button mat-flat-button class="confirm-btn" (click)="confirm()"
          [disabled]="loading || amount < data.sale.total">
  ...
  styles: [`
    ...
    h2 { font-size: 18px; font-weight: 700; color: #1a2332; margin: 0 0 16px; }
